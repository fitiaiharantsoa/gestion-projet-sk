 ...
 */
final class Version20250731132106 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project_file ADD project_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE project_file DROP projet_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project_file ADD projet_id INT NOT NULL');
        $this->addSql('ALTER TABLE project_file DROP project_id');
